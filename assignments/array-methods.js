...
runners.map(function(uppercase){
    allCaps.push(uppercase.first_name.toUpperCase());
    allCaps.sort();
})
console.log(allCaps); 
...
// problem 1: Top donators of more than 100 dollars, display their name & amount.
let topDonators = [];
topDonators = runners
...
// Problem 2: what was the average total 
let donationAverage = [];
